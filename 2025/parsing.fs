...
\ this may not seem like a general format, it is common in the
\ Advent of Code problems.
\
\ While >NUMBER deals in double precision I return a single
\ percision number. That's 64 bits which I hope is wide enough.
